        ...
        <div className="navbar bg-linear-to-r  from-[#09122C] via-[#FF9D23] to-[#09122C] text-neutral-content py-2">
            ...
            <div className="navbar-start">
                <div className="dropdown">
                    ...
                    <ul
                        tabIndex={0}
                        class="menu menu-sm dropdown-content bg-base-100 rounded-box z-1 mt-3 w-52 p-2 shadow gap-2 font-bold">
                        {link}
                    </ul>
                </div>
            ...
            <div className="navbar-center hidden lg:flex ">
                <ul className="menu menu-horizontal px-1 gap-3 font-bold text-lg">
                    {link}
                </ul>
            </div>
