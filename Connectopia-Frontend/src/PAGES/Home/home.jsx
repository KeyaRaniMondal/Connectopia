...
//             {/* Lottie Animation */}
//             <div className="flex justify-center pt-10 sm:pt-20 md:pt-32 w-full max-w-[500px] max-h-[60vh]">
//                 <DotLottieReact
//                     src={'Animation - 1738508469128.lottie'}
//                     loop
//                     autoplay
...
//             {/* Content Section */}
//             <div className="text-center md:text-left mt-10 sm:mt-32 md:mt-60">
//                 <h2 className="text-3xl sm:text-4xl md:text-6xl font-bold">Connectopia</h2>

//                 <p className="text-lg sm:text-2xl mt-4">
//                     <TypeAnimation
//                         sequence={['Connect', 1000, 'Collaborate', 1000, 'Create', 1000]}
//                         speed={50}
//                         repeat={Infinity}
//                     />
//                 </p>
...
//                 <div className="mt-10">
//                     <div className="mb-5">
//                         <button className="btn bg-[#c7c0c0] text-black border-[#462929] w-full sm:w-60">
...
//                     <div className="mb-5">
//                         <button className="btn bg-[#ffffff] text-black border-[#0b5014] w-full sm:w-60">
...
//                     <div>
//                         <button className="btn bg-black text-white border-black w-full sm:w-60">
